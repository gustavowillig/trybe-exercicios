const {uppercase, getPokemonDetails, handlePokemonSearch} = require('./exercício_dia1');


// describe('Testar a função', () => {
//     it('Verificar se uppercase é função', () => {
//         expect(typeof uppercase).toBe('function');
//         // expect(uppercase('olha só', console.log)).toBe('OLHA SÓ');
//     });
// });
